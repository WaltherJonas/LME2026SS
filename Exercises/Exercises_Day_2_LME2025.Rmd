...
a) Is the dependent variable linear related to the residuals?
```{r Ex2a, include=TRUE}
...
d) Test for multicollinearity. Which variables are correlated with each other and what might be the reason?
```{r Ex2d, include=TRUE}
